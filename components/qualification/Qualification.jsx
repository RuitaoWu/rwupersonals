                ...
                <div className="qualification__content">
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className="qualification__subtitle">San Diego State University</span>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <span className="qualification__subtitle">California State University, Northridge</span>
                            <div className="qualification__calender">
