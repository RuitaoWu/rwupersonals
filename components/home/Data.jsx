...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Ruitao Wu
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Entry Software Engineer</h3>
        <p className="home__description">I am a Software Engineer, and I am very passionate and dedicated to my work.</p>
